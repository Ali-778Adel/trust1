...
class ScreenResetPasswordOtp extends StatefulWidget {
  ...
  const ScreenResetPasswordOtp({Key? key ,required this.mobileNumber}) : super(key: key);

  @override
  _StateScreenResetPasswordOtp createState() => _StateScreenResetPasswordOtp();
}

class _StateScreenResetPasswordOtp extends State<ScreenResetPasswordOtp> {
  ...
  _verify()async{
    FocusScope.of(context).requestFocus(FocusNode());
    await context.read<AuthCubit>().confirmResetPassword(
      mobile: widget.mobileNumber,
