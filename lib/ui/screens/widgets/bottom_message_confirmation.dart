...
class BottomSheetMessageConfirmation extends StatefulWidget {
  ...
  const BottomSheetMessageConfirmation({Key? key,
    required this.title,
  ...
  static Future<bool> show(BuildContext context,
    ...
    await showModalBottomSheet<void>(
      ...
      builder: (BuildContext context) {
        return BottomSheetMessageConfirmation(
  ...
  class _StateBottomSheetMessageConfirmation extends State<BottomSheetMessageConfirmation>{
